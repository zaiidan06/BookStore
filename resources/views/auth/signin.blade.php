        ...
        <div class="form-container">
            ...
            <div id="loginForm" class="form space-y-6">
                <form action="login" method="POST">
                    ...
                    <button
                        type="submit"
                        class="w-full py-3 mt-6 text-white font-bold bg-green-500 rounded-md shadow-xl shadow-green-300 hover:bg-green-600 focus:ring-2 focus:ring-green-400 focus:outline-none transition-all duration-300 ease-in-out"
                    >
                        Login
                    </button>
                </form>
